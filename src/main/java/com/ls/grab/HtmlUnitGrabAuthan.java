...
public class HtmlUnitGrabAuthan {
	...
	public static void main(String[] args) throws FailingHttpStatusCodeException, MalformedURLException, IOException {
		...
		final HtmlPage orderResultPage = webClient
				.getPage("https://auchan.chinab2bi.com/auchan/sellOrderMainQry/query.hlt?page.togglestatus=null&accountModel.vendorNo=1356&accountModel.poTypeCheck=&accountModel.poId=&accountModel.dateType=0&accountModel.dateStart=2014-10-01&accountModel.dateEnd=2014-10-26&accountModel.planRecptDateStart=2014-10-01&accountModel.planRecptDateEnd=2014-10-26&accountModel.realRecptDateStart=2014-10-01&accountModel.realRecptDateEnd=2014-10-26&accountModel.orderStatus=&accountModel.storeNo=&accountModel.poType=&page.pageSize=10&page.pageNo=1&page.totalPages=9&page.jumpNumber=1");
