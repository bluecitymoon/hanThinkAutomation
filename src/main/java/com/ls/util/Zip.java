...
public class Zip {
    ...
    public static void main(String[] args){
        new Zip().unZip("C:\\Downloads\\20150625100534.zip","C:\\Downloads\\");
    }
     ...
     */  
	public List<String> unZip(String unZipfile, String destFile) {// unZipfileName需要解压的zip文件名
        ...
        try {
            ...
            Enumeration<ZipEntry> entries = this.zipFile.getEntries(); entries
                ...
                //生成他们解压后的一个文件  
                String fileName = destFile+File.separator+entry.getName();
