 ...
 * 
 */
@WebServiceClient(name = "Service1", targetNamespace = "http://HanThink.com/", wsdlLocation = "file:/D:/workspace/hanThinkAutomation/src/main/java/service2.wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICE1_QNAME = new QName("http://HanThink.com/", "Service1");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/D:/workspace/hanThinkAutomation/src/main/java/service2.wsdl");
    ...
    public Service1Soap getService1Soap() {
        return super.getPort(new QName("http://HanThink.com/", "Service1Soap"), Service1Soap.class);
    }
    ...
    public Service1Soap getService1Soap(WebServiceFeature... features) {
        return super.getPort(new QName("http://HanThink.com/", "Service1Soap"), Service1Soap.class, features);
    }
