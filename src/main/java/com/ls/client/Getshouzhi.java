 ...
 *         &lt;element name="khdid" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getshouzhi")
public class Getshouzhi {
    ...
    /**
     * Gets the value of the khdid property.
     * 
     */
    public int getKhdid() {
        return khdid;
    ...
    /**
     * Sets the value of the khdid property.
     * 
     */
    public void setKhdid(int value) {
        this.khdid = value;
    }
