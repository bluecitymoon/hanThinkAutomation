 ...
 *         &lt;element name="dwid" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getshoujicunhuodangan")
public class Getshoujicunhuodangan {
    ...
    /**
     * Gets the value of the dwid property.
     * 
     */
    public int getDwid() {
        return dwid;
    ...
    /**
     * Sets the value of the dwid property.
     * 
     */
    public void setDwid(int value) {
        this.dwid = value;
    }
