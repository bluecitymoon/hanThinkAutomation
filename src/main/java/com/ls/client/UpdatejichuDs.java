...
@XmlRootElement(name = "updatejichuDs")
public class UpdatejichuDs {
    ...
    protected String mk;
    protected UpdatejichuDs.Xiugaids xiugaids;
     ...
     * @return
     *     possible object is
     *     {@link UpdatejichuDs.Xiugaids }
     *     
     */
    public UpdatejichuDs.Xiugaids getXiugaids() {
        return xiugaids;
    }
     ...
     *     
     */
    public void setXiugaids(UpdatejichuDs.Xiugaids value) {
        this.xiugaids = value;
    }
