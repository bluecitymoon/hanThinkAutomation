...
CREATE TABLE `ls_company` (
  ...
  `emailSrc` varchar(255) DEFAULT NULL,
  `employeeCount` varchar(255) DEFAULT NULL,
  `fEurl` varchar(255) DEFAULT NULL,
  `isTracked` tinyint(1) DEFAULT NULL,
  `name` varchar(255) DEFAULT NULL,
  `phone` varchar(255) DEFAULT NULL,
  `phoneImgSrc` varchar(255) DEFAULT NULL,
  `phoneSrc` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `ls_company`
--
